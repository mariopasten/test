...
class KitTomaDecisiones extends Component {
    constructor(props) {
        super(props);
        this.state = {
            anchorEl: null,
    ...
    render() {
        ...
        return(
            <div className={classes.navContainer}>
                <Hidden lgUp='lgUp'>
                    <Button className={classes.iconReturn} component={Link} to={'/red'}>
                ...
                <Typography className={classes.text} variant="display1" gutterBottom align='left'>
                    Toma de decisiones para el impacto social:
                    <br/>
                    G Suite en acción
                </Typography>
                <Hidden lgUp='lgUp'>
                    <Typography className={classes.subText} variant="title" gutterBottom align='left'>
                        Tecnologías de la información 1 y 2
                    </Typography>
                </Hidden>
                <aside className={classes.kitDescription}>
                    <figure className={classes.imgKitContainer}>
                        <img className={classes.imgKit} src="https://s3.amazonaws.com/mayahii-frontend/img/gSuiteEnAccionN.png" alt=""/>
                    </figure>
                    ...
                    <a className={classes.iconBuy} href="https://www.mayahii.com/gsuiteenaccion#!/book" target="_blank">
                ...
                <aside className={classes.kitExtend}>
                    ...
                    <ul className={classes.list}>
                        ...
                        <li>
                            Libro del estudiante para Tecnologías de la Información 1
                        </li>
                        <li>
                            Libro del estudiante para Tecnologías de la Información 2
                        </li>
                        <li>
                            Examen diagnóstico
                        </li>
                        ...
                        <li>
                            Diploma de la Certificación “Toma de decisiones para el impacto social: G Suite en acción” (En caso de cumplir con los criterios)
                        </li>
                        {/* <li>
...
export default withStyles(styles)(
 connect(mapStateToProps,{})(KitTomaDecisiones)
);
