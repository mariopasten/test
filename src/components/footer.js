                ...
                <AppBar position="static" className={classes.appBar}>
                    <Toolbar className={classes.toolBar}>
                        <Tabs className={classes.navMenu}>
                            ...
                            <Tab className={classes.navItem} button="button" href={`http://ayuda.mayahii.com/`} label="Acerca de"/>
                            <Tab className={classes.navItem} button="button" href={`http://ayuda.mayahii.com/`} label="Fundación Mayahii"/>
                            <Tab className={classes.navItem} button="button" href={`http://ayuda.mayahii.com/`} label="Lineamientos de la Comunidad"/>
                            <Tab className={classes.navItem} button="button" href={`http://ayuda.mayahii.com/`} label="Aviso de privacidad"/>
                        </Tabs>
                    </Toolbar>
