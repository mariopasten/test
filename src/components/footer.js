                ...
                <AppBar position="static" className={classes.appBar}>
                    <Toolbar className={classes.toolBar}>
                        <Tabs className={classes.navMenu}>
                            ...
                            <Tab className={classes.navItem} button="button" component={Link} to={`/aboutUs`} label="Acerca de"/>
                            <Tab className={classes.navItem} button="button" href={`http://mayahii.org/`} label="Fundación Mayahii"/>
                            <Tab className={classes.navItem} button="button" component={Link} to={`/communityGuidelines`} label="Lineamientos de la Comunidad"/>
                            <Tab className={classes.navItem} button="button" component={Link} to={`/privacy`} label="Aviso de privacidad"/>
                        </Tabs>
                    </Toolbar>
